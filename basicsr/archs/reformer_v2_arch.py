...
class Reformer_v2(nn.Module):
    def __init__(self, 
        ...
        super(Reformer_v2, self).__init__()
        ...
        if middle_attn_chans != 0:
            ...
            middle_blks = [SimpleInvertedResidual(chan, stride=1, expand_ratio=dw_expand) for _ in range(middle_blk_num)]
...
# @ARCH_REGISTRY.register()
class ReformerLocal(Local_Base, Reformer_v2):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        Reformer_v2.__init__(self, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    net = Reformer_v2(inp_ch=3, width=16, patch_h=2, patch_w=2, 
                      middle_blk_num=3, middle_attn_chans=0, 
                      enc_blk_nums=[2, 4, 2, 3], enc_attn_chans=[0, 0, 0, 0],
                      dec_blk_nums=[3, 2, 4, 2], dec_attn_chans=[0, 0, 0, 0], 
