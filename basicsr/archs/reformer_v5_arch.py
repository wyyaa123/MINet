...
class Reformer_v5(nn.Module):
    def __init__(self, 
        ...
        super(Reformer_v5, self).__init__()
...
# @ARCH_REGISTRY.register()
class ReformerLocal(Local_Base, Reformer_v5):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        Reformer_v5.__init__(self, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    net = Reformer_v5(inp_ch=3, width=16, patch_h=2, patch_w=2, 
