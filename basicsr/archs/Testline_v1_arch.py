...
class BaseFPN(nn.Module):
    def __init__(self, img_channel, width=16, num_filters=256, act=nn.Hardswish):
        super().__init__()
        ...
        self.bneck = nn.Sequential(
            BaseBlock(kernel_size=3, in_size=16, expand_size=32, out_size=32, act=nn.ReLU, se=True, stride=2),

            BaseBlock(kernel_size=3, in_size=32, expand_size=64, out_size=32, act=nn.ReLU, se=True, stride=1),
            ######################################################################################################
            BaseBlock(kernel_size=3, in_size=32, expand_size=64, out_size=64, act=nn.ReLU, se=False, stride=2),
            BaseBlock(kernel_size=3, in_size=64, expand_size=128, out_size=64, act=nn.ReLU, se=False, stride=1),

            BaseBlock(kernel_size=3, in_size=64, expand_size=128, out_size=64, act=nn.ReLU, se=True, stride=1),
            BaseBlock(kernel_size=3, in_size=64, expand_size=128, out_size=64, act=nn.ReLU, se=True, stride=1),
            ######################################################################################################
            BaseBlock(kernel_size=3, in_size=64, expand_size=128, out_size=128, act=act, se=True, stride=2),
            BaseBlock(kernel_size=3, in_size=128, expand_size=128, out_size=128, act=act, se=True, stride=1),
            BaseBlock(kernel_size=3, in_size=128, expand_size=128, out_size=128, act=act, se=True, stride=1),
            BaseBlock(kernel_size=3, in_size=128, expand_size=128, out_size=128, act=act, se=True, stride=1),
            BaseBlock(kernel_size=3, in_size=128, expand_size=128, out_size=128, act=act, se=True, stride=1),
            ...
            BaseBlock(kernel_size=3, in_size=128, expand_size=128, out_size=128, act=act, se=True, stride=1),
            ######################################################################################################
            BaseBlock(kernel_size=3, in_size=128, expand_size=256, out_size=256, act=act, se=True, stride=2),
            BaseBlock(kernel_size=3, in_size=256, expand_size=256, out_size=256, act=act, se=True, stride=1),
            BaseBlock(kernel_size=3, in_size=256, expand_size=256, out_size=256, act=act, se=True, stride=1),
        ...
        self.encoder0 = nn.Sequential(self.bneck[0:2]) # inp: 8, oup: 16, shape: down
        ...
        self.lateral3 = nn.Conv2d(256, num_filters, kernel_size=1, bias=False) # inp: 256, oup: 256, shape: unchange
        self.lateral2 = nn.Conv2d(128, num_filters, kernel_size=1, bias=False) # inp: 128, oup: 256, shape: unchange
        self.lateral1 = nn.Conv2d(64, num_filters, kernel_size=1, bias=False) # inp: 64, oup: 256, shape: unchange
        self.lateral0 = nn.Conv2d(32, num_filters, kernel_size=1, bias=False) # inp: 32, oup: 256, shape: unchange
...
class TestFPNNet_v1(nn.Module):

    def __init__(self, inp_ch, output_ch=3, num_filters=64, num_filters_fpn=256):
        super().__init__()
